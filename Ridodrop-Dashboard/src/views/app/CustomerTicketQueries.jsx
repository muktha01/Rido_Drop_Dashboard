...
import { Box, Typography, Button, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, OutlinedInput, InputAdornment, Stack, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
const mockQueries = [
  { id: 1, name: 'John Doe', query: 'Unable to login to the app.' },
  { id: 2, name: 'Jane Smith', query: 'Payment not processed.' },
  { id: 3, name: 'Amit Kumar', query: 'App crashes on start.' }
];

export default function CustomerTicketQueries() {
